...
const NammaKannadaPrivacyPolicy = () => {
  return (
    <>
      <SEOHead
        title="Namma Kannada Privacy Policy"
        description="Privacy Policy for Namma Kannada app"
        keywords="Namma Kannada Privacy Policy, Data Protection, App Privacy"
        url="https://aadish.dev/legal/projects/nammakannada/privacypolicy"
        noIndex={true}
      />
      <div className="privacy-container">
        <div className="privacy-card">
          ...
          <ul className="privacy-list">
            ...
            <li>
              <p className="privacy-text">
                <strong>Application</strong> refers to Namma Kannada, the
            ...
            <li>
              <p className="privacy-text">
                ...
                in this Agreement) refers to Namma Kannada.
              </p>
            </li>
            <li>
              <p className="privacy-text">
...
export default NammaKannadaPrivacyPolicy;
